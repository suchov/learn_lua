-- Initialize a variable with any temperature value in Celsius. Your script should
-- calculate and display the value in Celsius converted to Farhenheit. Assuming TC is the 
